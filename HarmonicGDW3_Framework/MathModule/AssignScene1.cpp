...
void AssignScene1::InitScene(float windowWidth, float windowHeight)
{
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(0.f, 360.f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Pickup>(entity).SetAmmo(0, 5, 0);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-224.323,692.609, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-264.323, 652.4, 5.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(862.4f, 868.4f, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(862.4f, 818.4f, 5.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(862.4f, 918.4f, 5.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(812.4f, 868.4f, 5.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(912.4f, 868.4f, 5.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(932.4f, 868.4f, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Pickup>(entity).SetAmmo(5, 0, 0);
		ECS::GetComponent<Sprite>(entity).LoadSprite(ammo, 6, 6, true, &animController);

		ECS::GetComponent<Transform>(entity).SetPosition(vec3(792.4f, 868.4f, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(862.4f, 938.4f, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(812.4f, 918.4f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(812.4f, 818.4f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(912.4f, 818.4f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(912.4f, 918.4f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(303.9f, 1148.2f, 10.f));
		...
		//sets up the identifier
		unsigned int bitHolder = EntityIdentifier::SpriteBit() | EntityIdentifier::TransformBit();
		ECS::SetUpIdentifier(entity, bitHolder, "HalfSideWall6");
	}
	{
		//Creates entity 
		auto entity = ECS::CreateEntity();
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(343.9f, 1148.2f, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(343.9f, 1188.2f, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(343.9f, 1108.2f, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(243.9f, 1188.2f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(243.9f, 1108.2f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(203.9f, 1148.2f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(947.6f, 1070.4f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(867.f, 1050.f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(947.5f, 1116.8f, 10.f));
	...
	}
	{
		...
		//sets up components
		std::string fileName = "HalfSideWall.png";
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 20, 88);

		ECS::GetComponent<Transform>(entity).SetPosition(vec3(458.2f, 1057.7f, 10.f));
	...
	}
	{
		...
		//sets up components
		std::string fileName = "HalfSideWall.png";
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 20, 116);

		ECS::GetComponent<Transform>(entity).SetPosition(vec3(458.2f, 1225.f, 10.f));
	...
	}
	{
		...
		//sets up components
		std::string fileName = "HalfSideWall.png";
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 20, 135);

		ECS::GetComponent<Transform>(entity).SetPosition(vec3(144.3f, 1080.2f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(144.3f, 1247.4f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(43.4f, 1080.2f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(43.4f, 945.5f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(43.4f, 860.1f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-42.1f, 869.6f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-42.1f, 1005.4f, 10.f));
	...
	}
	{
		...
		//sets up components
		std::string fileName = "HalfSideWall.png";
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 20, 153);

		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-42.1f, 1136.9f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(798.3f, 1091.7f, 10.f));
		...
		//sets up the identifier
		unsigned int bitHolder = EntityIdentifier::SpriteBit() | EntityIdentifier::TransformBit();
		ECS::SetUpIdentifier(entity, bitHolder, "LongWall6");
	}
	{
		//creates entity
		auto entity = ECS::CreateEntity();
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(646.2f, 1091.7f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(546.4f, 1091.7f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(798.3f, 1176.8f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(646.2f, 1176.8f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(546.4f, 1176.8f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(879.f, 1176.8f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(370.1f, 1272.5f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(220.f, 1272.5f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(230.9f, 1024.f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(370.6f, 1024.f, 10.f));
	...
	}
	{
		...
		//sets up components
		std::string fileName = "longWall.png";
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 114, 20);

		ECS::GetComponent<Transform>(entity).SetPosition(vec3(94.7f, 1137.6f, 10.f));
	...
	}
	{
		...
		//sets up components
		std::string fileName = "longWall.png";
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 188, 20);

		ECS::GetComponent<Transform>(entity).SetPosition(vec3(41.9f, 1222.4f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(459.7f, 1134.5, 99.f));

		//Sets up the identifier
		unsigned int bitHolder = EntityIdentifier::SpriteBit() | EntityIdentifier::TransformBit() | EntityIdentifier::AnimationBit();
		ECS::SetUpIdentifier(entity, bitHolder, "RegularDoor6");
	}
	{
		//Creates entity 
		auto entity = ECS::CreateEntity();
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(142.8f, 1179.9f, 99.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-619.f, 652.f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-619.f, 672.f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-619.f, 632.f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-639.f, 652.f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-599.f, 652.f, 10.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-619.f, 712.f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-619.f, 582.f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-659.f, 652.f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-613.f, 695.f, 10.f));
		auto& tempSpr = ECS::GetComponent<Sprite>(entity);
		auto& tempPhsBody = ECS::GetComponent<PhysicsBody>(entity);
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-576.923, 785.041, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-636.923, 845.041, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-636.923, 785.041, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-576.923, 845.041, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-576.923, 509.739, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-636.923, 449.739, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-576.923, 449.739, 5.f));
	...
	}
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(-636.923, 509.739, 5.f));
	...
	// level 8
	{
		...
		tempPhsBody = PhysicsBody(float(tempSpr.GetWidth() - 30), float(tempSpr.GetHeight() - 30),
			vec2(0.f, 0.f),
			CollisionIDs::Win(), CollisionIDs::Player(), true);
